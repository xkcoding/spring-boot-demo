...
public final class DemoServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.xkcoding.grpc.protocol.DemoRequest,
      com.xkcoding.grpc.protocol.DemoResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = com.xkcoding.grpc.protocol.DemoRequest.class,
      responseType = com.xkcoding.grpc.protocol.DemoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.xkcoding.grpc.protocol.DemoRequest,
      com.xkcoding.grpc.protocol.DemoResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<com.xkcoding.grpc.protocol.DemoRequest, com.xkcoding.grpc.protocol.DemoResponse> getHelloMethod;
      ...
      synchronized (DemoServiceGrpc.class) {
        if ((getHelloMethod = DemoServiceGrpc.getHelloMethod) == null) {
          DemoServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<com.xkcoding.grpc.protocol.DemoRequest, com.xkcoding.grpc.protocol.DemoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.xkcoding.grpc.protocol.DemoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.xkcoding.grpc.protocol.DemoResponse.getDefaultInstance()))
  ...
  public static abstract class DemoServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(com.xkcoding.grpc.protocol.DemoRequest request,
        io.grpc.stub.StreamObserver<com.xkcoding.grpc.protocol.DemoResponse> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                com.xkcoding.grpc.protocol.DemoResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class DemoServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<DemoServiceBlockingStub> {
    ...
    /**
     */
    public com.xkcoding.grpc.protocol.DemoResponse hello(com.xkcoding.grpc.protocol.DemoRequest request) {
  ...
  public static final class DemoServiceFutureStub extends io.grpc.stub.AbstractFutureStub<DemoServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.xkcoding.grpc.protocol.DemoResponse> hello(
        com.xkcoding.grpc.protocol.DemoRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.xkcoding.grpc.protocol.DemoRequest) request,
              (io.grpc.stub.StreamObserver<com.xkcoding.grpc.protocol.DemoResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class DemoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.xkcoding.grpc.protocol.DemoProto.getDescriptor();
    }
