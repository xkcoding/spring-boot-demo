...
[shell]
----
curl --location --request POST 'http://193.112.94.161:8080/oauth/token' \
...
[source]
----
curl --location --request POST 'http://193.112.94.161:8080/oauth/check_token' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--header 'Authorization: Basic b2F1dGgyOm9hdXRoMg==' \
...
[source]
----
curl --location --request GET 'http://193.112.94.161:8080/oauth/token_key' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--header 'Authorization: Basic b2F1dGgyOm9hdXRoMg=='
----
