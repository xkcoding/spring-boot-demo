...
public class DataSourceShardingConfig {
    ...
    private Map<String, DataSource> dataSourceMap() {
        ...
        ds0.setPassword("JiangKai@Password123");

        // 配置第二个数据源
        HikariDataSource ds1 = new HikariDataSource();
        ds1.setDriverClassName("com.mysql.cj.jdbc.Driver");
        ds1.setJdbcUrl("jdbc:mysql://193.112.94.161:3306/spring-boot-demo2?useUnicode=true&characterEncoding=UTF-8&useSSL=false&autoReconnect=true&failOverReadOnly=false&serverTimezone=GMT%2B8");
        ds1.setUsername("root");
        ds1.setPassword("JiangKai@Password123");
